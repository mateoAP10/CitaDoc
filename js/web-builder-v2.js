...
(function (window, document) {
  ...
  function _HTML() {
    ...
    +         '<optgroup label="◼  Split — Texto · Foto lado a lado">'
    +           '<option value="surgical-authority">Surgical Authority — clínico, oscuro, experto</option>'
    +           '<option value="neoclinic">Neoclinic — tecnológico, institucional</option>'
    ...
    +         '</optgroup>'
    +         '<optgroup label="▌  Cinemático — Foto fullscreen + texto flotante">'
    +           '<option value="modern-story">Modern Story — oscuro, editorial, cinematográfico</option>'
    +           '<option value="aesthetic-luxe">Aesthetic Luxe — lujo, dorado, premium</option>'
    +           '<option value="personal-brand">Personal Brand — médico como marca personal</option>'
    +         '</optgroup>'
    +         '<optgroup label="○  Minimalista — Foto superior, ritmo limpio">'
  ...
  async function _save(silent) {
    ...
    try {
      ...
      var config = Object.assign({}, _liveConfig, {
        ...
        city:             v('wbe-ciudad')       || _liveConfig.city             || '',
        headline:         v('wbe-headline')     || _liveConfig.headline         || '',
        subheadline:      v('wbe-subheadline')  || _liveConfig.subheadline      || '',
        hero_text:        v('wbe-bio')          || _liveConfig.hero_text        || '',
        about_text:       v('wbe-about')        || _liveConfig.about_text       || '',
        philosophy:       v('wbe-philosophy')   || _liveConfig.philosophy       || '',
        cta_final:        v('wbe-cta')          || _liveConfig.cta_final        || '',
        primary_color:    v('wbe-color')        || _liveConfig.primary_color    || '#0b7c6e',
        dna:              dnaVal,
        visual_dna:       dnaVal,
